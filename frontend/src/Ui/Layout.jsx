...
function Layout() {
  return (
    <div className="flex flex-col h-screen overflow-y-scroll" >
      ...
      {/* <li>Dashboard</li> */}
      <Link to="/book-event"  className="bg-blue-200 py-4 rounded-md text-center">Book events</Link>
      <Link to="/availability"  className="bg-blue-200 py-4 rounded-md text-center">My Availability</Link>
      <Link to="/events"  className="bg-blue-200 py-4 rounded-md text-center">My Events</Link>
      <Link to="/create-event"  className="bg-blue-200 py-4 rounded-md text-center">Create Event</Link>
    </div>
